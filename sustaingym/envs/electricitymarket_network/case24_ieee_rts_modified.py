...
Modifications by Luc:
- Add some variation to costs of generators (that would otherwise be the same)
"""
...
def case24_ieee_rts():
    ...
    # node, power capacity, energy capacity, eff_c, eff_d, soc_0, soc_f, soc_min, soc_max, cost_c, cost_d
    ppc["battery"] = array([])
