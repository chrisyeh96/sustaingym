"""
This module implements baseline algorithms for the CongestedElectricityMarketEnv.
"""
...
class BaseEMAlgorithm:
    ...
    Attributes:
        env (CongestedElectricityMarketEnv): electricity market environment
    ...
    def get_action(self, observation: dict[str, Any]) -> np.ndarray:
        ...
        Args:
            observation: observation from CongestedElectricityMarketEnv.
    ...
    def run(self, seeds: Sequence[int] | int) -> pd.DataFrame:
        ...
        Args:
            seeds: if a list, on each episode run, CongestedElectricityMarketEnv is reset using
        ...
        Returns:
            ...
            See CongestedElectricityMarketEnv for more info.
        """
        ...
        for seed in tqdm(seeds):
            ...
            # for rb in info['results']:
            #     results[rb].append(info['results'][rb])

            results['seed'].append(seed)
            results['reward'].append(episode_reward)
            results['energy_reward'].append(episode_energy_reward)
            results['carbon_reward'].append(episode_carbon_reward)
