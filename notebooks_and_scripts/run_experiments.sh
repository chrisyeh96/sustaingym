...
python -m notebooks_and_scripts.train -n 1011 -t Summer 2021 -e Summer 2021 -m PPO -d -r 345
...
python -m notebooks_and_scripts.train -n 1011 -t Summer 2021 -e Summer 2021 -m A2C -d -r 345
