...
python -m notebooks_and_scripts.train --exp 321 --seed 123 --project_action_in_env True --model ppo --site caltech --train_period summer2021 --test_periods summer2021
python -m notebooks_and_scripts.train --exp 322 --seed 246 --project_action_in_env True --model ppo --site caltech --train_period summer2021 --test_periods summer2021
python -m notebooks_and_scripts.train --exp 323 --seed 369 --project_action_in_env True --model ppo --site caltech --train_period summer2021 --test_periods summer2021
python -m notebooks_and_scripts.train --exp 421 --seed 123 --project_action_in_env True --model a2c --site caltech --train_period summer2021 --test_periods summer2021
python -m notebooks_and_scripts.train --exp 422 --seed 246 --project_action_in_env True --model a2c --site caltech --train_period summer2021 --test_periods summer2021
python -m notebooks_and_scripts.train --exp 423 --seed 369 --project_action_in_env True --model a2c --site caltech --train_period summer2021 --test_periods summer2021
